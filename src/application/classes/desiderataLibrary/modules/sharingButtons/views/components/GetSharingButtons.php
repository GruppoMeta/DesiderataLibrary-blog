<?php
class desiderataLibrary_modules_sharingButtons_views_components_GetSharingButtons extends org_glizy_components_Component
{
    ...
    function init()
    {
        ...
        $this->shareButtons = desiderataLibrary_modules_sharingButtons_views_SharingButton::getSharingButtonList();
    }
