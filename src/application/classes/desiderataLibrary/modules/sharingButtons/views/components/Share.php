<?php
class desiderataLibrary_modules_sharingButtons_views_components_Share extends org_glizy_components_Groupbox
{
    function init()
    {
        parent::init();
    ...
    function process()
    {
        $shareButtons = desiderataLibrary_modules_sharingButtons_views_SharingButton::getSharingButtonList();
