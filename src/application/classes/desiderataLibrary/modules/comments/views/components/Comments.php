<?php
class desiderataLibrary_modules_comments_views_components_Comments extends org_glizy_components_RecordSetList
{
    function init()
    {
        ...
        $this->defineAttribute('processCell',    false,     'desiderataLibrary.modules.comments.views.renderer.CellComment',    COMPONENT_TYPE_STRING);
        parent::init();
